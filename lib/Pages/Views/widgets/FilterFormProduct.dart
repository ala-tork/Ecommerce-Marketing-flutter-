...
class FilterFormProduct extends StatefulWidget {
  ...
  @override
  State<FilterFormProduct> createState() => _FilterFormProductState();
}

class _FilterFormProductState extends State<FilterFormProduct> {
  double _minValue = 0;
  ...
  TextEditingController _codeBar = TextEditingController();
  TextEditingController _CodeProd = TextEditingController();
  ...
  void initState() {
    ...
    if(widget.codeBar!=null)
    _codeBar.text=widget.codeBar!;
    if(widget.codeProd!=null)
    _CodeProd.text=widget.codeProd!;
    if(widget.reference!=null)
    _reference.text=widget.reference!;
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.pop(context, {
                          ...
                          "codeBar":_codeBar.text,
                          "codeProd":_CodeProd.text,
