...
class AppBarForBottomBarViews extends StatefulWidget implements PreferredSizeWidget {
  final Daimons;
  final title;

  const AppBarForBottomBarViews({super.key, this.Daimons = 122, this.title});

  @override
  State<AppBarForBottomBarViews> createState() => _AppBarForBottomBarViewsState();
...
class _AppBarForBottomBarViewsState extends State<AppBarForBottomBarViews> {
  /** User  */
  User? user;
  int? idUser;
